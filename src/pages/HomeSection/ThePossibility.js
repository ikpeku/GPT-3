  ...
  return (
    <div className="sm:flex items-center">
      ...
      <div className="rightSide flex flex-col gap-6 sm:w-1/2 p-6">
        ...
        <h2 className='bg-gradient-to-r from-[#AE67FA] via-[#F49867] to-[#F49867] bg-clip-text text-transparent lg:w-5/6 font-bold text-2xl lg:text-5xl'>The possibilities are beyond your imagination</h2>
