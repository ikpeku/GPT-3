...
export const Blog = () => {
  ...
  return (
    <div className="w-full object-cover pb-24">
      <h2 className="bg-gradient-to-r from-[#AE67FA] via-[#F49867] to-[#F49867] bg-clip-text text-transparent sm:w-9/12 lg:w-[45%] font-semibold text-2xl sm:text-4xl py-14">
        A lot is happening, We are blogging about it.
      </h2>

      <div className="sm:flex gap-8">

        <div  className='sm:w-1/2 min-h-full'>
        ...
        <div className='grid grid-cols-2 gap-5 sm:w-1/2'>
            {
                matrix.map(({img, text}) => (
                   <div key={img}>
